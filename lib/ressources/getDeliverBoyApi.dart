...
class GetDeliverBoy {
  ...
  changeStatus(id, status) async {
    ...
    final response = await client.put(
        'https://admin.ppc-drc.com/api/v1/deliverboy/' + id,
        headers: myhead,
  ...
  fetchAll() async {
    ...
    var response = await client
        .get('https://admin.ppc-drc.com/api/v1/deliverboy', headers: myhead);

    var res = json.decode(response.body);

    final listdeliverboys = DeliverBoyModelFromJson(res['data']);

    listdeliverboys.reversed;

    return listdeliverboys;
  }

  getDeliverBoyID() async {
  ...
  getZoneList(id) async {
    ...
    var response = await client.get('https://admin.ppc-drc.com/api/v1/deliverboy/' + id,  headers: myhead);
