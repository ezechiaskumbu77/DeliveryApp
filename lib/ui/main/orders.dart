...
//import 'package:delivery_template/ui/main/signalproblem.dart';
...
class OrdersScreen extends StatefulWidget {
  ...
  OrdersScreen({this.callback, this.params});
...
class _OrdersScreenState extends State<OrdersScreen>
  ...
  _updateLocation() async {
    print('begin execute geo');

    var resp = await geoloc.getCurrent();

    if (resp != null) {
      setState(() {
        geo.updateMyLocation(resp);
      });
    } else {
      print('impssible to get location');
    }
    //return;
  }
