...
import 'package:delivery_template/ui/widgets/iAvatarWithPhotoFileCaching.dart';
import 'package:delivery_template/ui/widgets/ibutton2.dart';
import 'package:delivery_template/ui/widgets/ilist4.dart';
        ...
        child: Column(
          children: <Widget>[
            ...
            IList4(text: '${strings.get(32)}:', // 'Username',
              ...
              text2: widget.userL.name,
              textStyle2: theme.text14bold,
            ),
            SizedBox(height: 10,),
            IList4(text: 'Téléphone:', // 'E-mail',
              textStyle: theme.text14bold,
              text2:  widget.userL.phone,
              textStyle2: theme.text14bold,
            ),
            SizedBox(height: 10,),
            IList4(text: 'Type d\'utilisateur:', // 'Phone',
              textStyle: theme.text14bold,
              text2:  widget.userL.role,
              textStyle2: theme.text14bold,
            ),
            SizedBox(height: 10,),
