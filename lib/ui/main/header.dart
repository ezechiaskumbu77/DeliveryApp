...
import 'package:delivery_template/ui/widgets/iinkwell.dart';
...
//  getUnreadNotification() ;
  ...
  {
      GetNotification notif = GetNotification();
    await notif.getUnreadNotifations().then((value) {
        setState(() {
         
          if (value != null) {
            unreadNotif = value;
            countUnreadNotif = value.length;
          }
        });
      });
  }
  ...
  _notify() {
          ...
          Align(
            ...
            child: Container(
              ...
              child: Align(
                alignment: Alignment.center,
                child:
                    Text(countUnreadNotif.toString(), style: theme.text10white),
              ),
            ),
          )
        ],
    ...
    onTap: (){      Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => AllNotificationScreen(unreadNotifs:unreadNotif)));
